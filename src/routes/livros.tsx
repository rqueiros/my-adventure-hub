    ...
    <div className="min-h-screen bg-background text-foreground p-6 md:p-12 pb-32">
      <div className="max-w-6xl mx-auto animate-fade-up">
        ...
        <p className="text-muted-foreground max-w-3xl mb-12 text-sm md:text-base leading-relaxed">
          Obras de autoria, entre o ensaio técnico e a divulgação científica. Cada livro é o resultado de anos
          de investigação e prática, traduzidos para uma linguagem acessível a estudantes, professores e curiosos.
        </p>
