...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Personal dashboard of books, articles, events, projects, travels and running." },
    ],
  }),
});
  ...
  return (
    <div className="min-h-screen bg-background text-foreground p-6 md:p-12 pb-32">
      ...
      <main className="max-w-7xl mx-auto space-y-20">
        {/* Aggregated Facet Tiles (clickable, with icons + colors) */}
        <section>
          ...
          {allLatest && (
            ...
            >
              ...
              <div className="absolute top-4 left-4 font-mono text-[10px] tracking-widest bg-primary text-primary-foreground px-2 py-1 rounded">
                ▸ LATEST · {facetMeta[allLatest.facet].label}
              </div>
              <div className="p-6">
        ...
        <section className="grid lg:grid-cols-2 gap-12">
          <div className="animate-fade-up space-y-6" style={{ animationDelay: "500ms" }}>
            <div className="flex items-center gap-4 border-l-2 border-primary pl-4">
              <h2 className="text-xl font-bold uppercase tracking-widest">Latest Activity</h2>
              <div className="flex-1 h-px bg-border" />
            </div>
