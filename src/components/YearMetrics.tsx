...
export function YearMetrics() {
  ...
  const tiles = [
    { Icon: BookOpen,    label: "Livros publicados", value: booksY, color: "text-amber-400",   border: "border-amber-400/30",   bg: "bg-amber-400/[0.05]" },
    { Icon: PenSquare,   label: "Artigos de opinião", value: opedsY, color: "text-rose-400",   border: "border-rose-400/30",    bg: "bg-rose-400/[0.05]" },
    { Icon: Footprints,  label: "Corridas realizadas", value: racesY.length, color: "text-primary", border: "border-primary/30", bg: "bg-primary/[0.05]" },
    { Icon: Trophy,      label: "Quilómetros corridos", value: km, color: "text-emerald-400", border: "border-emerald-400/30", bg: "bg-emerald-400/[0.05]" },
  ];
  ...
  return (
    <section className="animate-fade-up" style={{ animationDelay: "350ms" }}>
      <div className="flex items-center gap-4 border-l-2 border-primary/60 pl-4 mb-6">
        <h2 className="text-xl font-bold uppercase tracking-widest">{year} em números</h2>
